    ...
    def __init__(self):
        ...
        writer_prompt = ChatPromptTemplate.from_messages(
            [
                ...
                MessagesPlaceholder("history"), ## A placeholder for the message history (previous drafts).
                ## formatted input (email_information) provided to the agent which contains Email Category, Email Content, Retrieved Information
                ## Refer write_draft_email function where email_writer is called
