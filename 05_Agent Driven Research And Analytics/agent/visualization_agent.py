...
def create_visualization_agent(llm, members, working_directory):
    ...
    tools = [read_document, # Reading the document
             execute_code, # Execute Python code in a specified conda environment and return the result.
             execute_command # Execute a command in a specified Conda environment and return its output.
            ]
